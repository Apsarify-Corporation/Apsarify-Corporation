...
export default function Home() {
  return (
    <div className="bg-1 h-[90vh] w-full bg-no-repeat bg-cover flex flex-col py-13 font-bold">
      <video  autoPlay loop muted className="opacity-30 absolute">
        <source src="/overlays/overlay.mp4" type="video/mp4" />
        Your browser does not support.
    </video>
      <h2 className={"z-1 text-4xl font-normal mx-auto bg-gradient-to-r from-white to-[#fafafa00] bg-clip-text text-transparent text-center" + " " + manrope.className}>{"ELEVATE YOUR VISION,IGNITE"}<br/>{"TOMORROW'S INNOVATION."}</h2>
